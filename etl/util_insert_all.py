...
module_names = [
    #'etl.insert_ep_activities_calories_intraday_by_date',
    #'etl.insert_ep_activities_distance_intraday_by_date',
    #'etl.insert_ep_activities_elevation_intraday_by_date',
    #'etl.insert_ep_activities_floors_intraday_by_date',
    'etl.insert_ep_activities_steps_intraday_by_date',
    #'etl.insert_ep_ecg_intraday_by_date',
...
def run_all_modules():
    for module_name in module_names:
        ...
        # Get last response date to print out (module will get it again - future could do it here and pass to module)
        last_response_date_str = get_last_response(module_name.replace("etl.", "").replace("insert_", "get_"))
