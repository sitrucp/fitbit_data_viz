# get_ep_activities_distance_intraday_by_date.py
...
def get_data(start_date, end_date):
    ...
    module_str = 'get_ep_activities_distance_intraday_by_date'
    ...
    url = f'https://api.fitbit.com/1/user/-/activities/distance/date/loop_date/1d/1min.json'
